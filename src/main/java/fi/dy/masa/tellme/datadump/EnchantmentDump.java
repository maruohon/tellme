...
public class EnchantmentDump
{
    ...
    {
        DataDump enchantmentDump = new DataDump(6, format);
        ...
        for (Identifier key : Registries.ENCHANTMENT.getIds())
        {
            ...
            if (ench != null)
            {
                ...
                String maxLvl = String.valueOf(ench.getMaxLevel());
                ...
                enchantmentDump.addData(regName, name, maxLvl, target, rarityStr, String.valueOf(intId));
            }
        }

        enchantmentDump.addTitle("Registry name", "Name", "Max lvl", "Target", "Rarity", "ID");
        enchantmentDump.setColumnProperties(5, DataDump.Alignment.RIGHT, true); // id
