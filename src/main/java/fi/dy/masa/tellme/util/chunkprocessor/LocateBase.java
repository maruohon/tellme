...
public abstract class LocateBase extends ChunkProcessorAllChunks
{
    ...
    protected void addLine(DataDump dump, LocationData data)
    {
        ...
        else
        {
            ...
            String strRegion = String.format(FMT_REGION, rx, rz);
    ...
    public enum LocateType
    {
        ...
        TILE_ENTITY ("tile-entity", "tile_entities",    () -> Registry.BLOCK_ENTITY_TYPE, LocateBlockEntities::new);
        ...
        LocateType(String argument,
                   String plural,
                   Supplier<Registry<?>> registrySupplier,
