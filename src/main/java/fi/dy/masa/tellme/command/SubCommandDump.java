...
import fi.dy.masa.tellme.datadump.BiomeProviderTypesDump;
import fi.dy.masa.tellme.datadump.BlockDump;
import fi.dy.masa.tellme.datadump.BlockStatesDump;
import fi.dy.masa.tellme.datadump.ChunkGeneratorTypesDump;
import fi.dy.masa.tellme.datadump.ChunkStatusDump;
import fi.dy.masa.tellme.datadump.CommandDump;
import fi.dy.masa.tellme.datadump.ContainerTypesDump;
import fi.dy.masa.tellme.datadump.DataDump;
import fi.dy.masa.tellme.datadump.DecoratorDump;
...
import fi.dy.masa.tellme.datadump.MemoryModuleTypesDump;
import fi.dy.masa.tellme.datadump.ModDimensionsDump;
import fi.dy.masa.tellme.datadump.ModListDump;
import fi.dy.masa.tellme.datadump.PaintingTypesDump;
import fi.dy.masa.tellme.datadump.ParticleTypesDump;
...
import fi.dy.masa.tellme.datadump.RecipeSerializersDump;
import fi.dy.masa.tellme.datadump.ScheduleDump;
import fi.dy.masa.tellme.datadump.SensorTypesDump;
...
import fi.dy.masa.tellme.datadump.SurfaceBuilderDump;
...
import fi.dy.masa.tellme.datadump.WorldCarversDump;
...
public class SubCommandDump
{
    ...
    public static HashMap<String, DumpLineProvider> getDumpProviders()
    {
        ...
        dumpProviders.put("biome-provider-types",       (world, entity, format) -> BiomeProviderTypesDump.getFormattedDump(format));
        ...
        dumpProviders.put("chunk-generator-types",      (world, entity, format) -> ChunkGeneratorTypesDump.getFormattedDump(format));
        ...
        dumpProviders.put("container-types",            (world, entity, format) -> ContainerTypesDump.getFormattedDump(format));
        dumpProviders.put("creative-tabs",              (world, entity, format) -> ItemGroupDump.getFormattedCreativetabDump(format));
        dumpProviders.put("decorators",                 (world, entity, format) -> DecoratorDump.getFormattedDump(format));
        ...
        dumpProviders.put("memory-module-types",        (world, entity, format) -> MemoryModuleTypesDump.getFormattedDump(format));
        dumpProviders.put("mod-dimensions",             (world, entity, format) -> ModDimensionsDump.getFormattedDump(format));
        ...
        dumpProviders.put("particle-types",             (world, entity, format) -> ParticleTypesDump.getFormattedDump(format));
        ...
        dumpProviders.put("recipe-serializers",         (world, entity, format) -> RecipeSerializersDump.getFormattedDump(format));
        dumpProviders.put("schedules",                  (world, entity, format) -> ScheduleDump.getFormattedDump(format));
        dumpProviders.put("sensor-types",               (world, entity, format) -> SensorTypesDump.getFormattedDump(format));
        ...
        dumpProviders.put("surface-builders",           (world, entity, format) -> SurfaceBuilderDump.getFormattedDump(format));
        ...
        dumpProviders.put("world-carvers",              (world, entity, format) -> WorldCarversDump.getFormattedDump(format));
