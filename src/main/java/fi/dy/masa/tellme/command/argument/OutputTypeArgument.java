...
public class OutputTypeArgument implements ArgumentType<OutputType>
{
    ...
    public static final DynamicCommandExceptionType NO_SUCH_TYPE_EXCEPTION = new DynamicCommandExceptionType((v) -> Text.literal("Unknown output type: " + v));
    private static final SimpleCommandExceptionType EMPTY_TYPE = new SimpleCommandExceptionType(Text.literal("No output type given"));
